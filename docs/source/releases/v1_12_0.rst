...
* Installation Updates
  ...
  * Replace VERSION 0.0.0 lunarref/_version.py
  * Update to standard .gitignore
  * Add lunarref/__init__.py
...
::
  ...
  removed: setup.py
  modified: .gitignore
  new: lunarref/_version.py
  new: lunarref/__init__.py
  removed: VERSION
...
::
  ...
  new: docs/source/lunarref_api/index.rst
