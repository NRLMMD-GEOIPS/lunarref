...
full_integ_test_calls = [
    ...
    "$repopath/tests/scripts/viirs.sh Lunar-Ref",
    "$repopath/tests/scripts/viirs.sh Lunar-Ref-IR",
    "$repopath/tests/scripts/viirs.sh Overshooting-Top",
]
